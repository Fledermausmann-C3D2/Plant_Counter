...
# ---------------- DEBUG SETTINGS ----------------
DEBUG_MODE = True
STEP_MODE = True   # True = manuell weiter, False = Live-Playback
...
def run_analysis():
    ...
    # ---------------- IMAGE LOOP + Debug Window----------------

    cv2.namedWindow("Plant Detection Debug", cv2.WINDOW_NORMAL)
    cv2.resizeWindow("Plant Detection Debug", 800, 600)
    ...
    for i, path in enumerate(image_paths):
        ...
        for label in np.unique(markers):
            ...
            if area > 900:
                ...
                cv2.putText(debug_img, str(area), (x, y-5),
        ...
        # ---------------- DEBUG VIEW ----------------
        if DEBUG_MODE:
            cv2.imshow("Plant Detection Debug", debug_img)
